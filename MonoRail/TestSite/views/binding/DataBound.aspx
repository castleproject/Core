    ...
    <form id="form1" runat="server">
		...
		<ul>
			<li>GridView:<asp:GridView ID="grdEmployees" runat="server" DataSource="<%# Employees %>"
				DataKeyNames="Id,Name" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" 
			...
			<mr:ControllerBinding ControlID="grdEmployees">
				<mr:ActionBinding EventName="RowCommand">
					...
					<ActionArguments>
						...
						<mr:ActionArgument Expression="$this.DataKeys[$event.CommandArgument].Value" Name="id" />
						<mr:ActionArgument Expression="$this.DataKeys[$event.CommandArgument]['Name']" Name="name" />
					</ActionArguments>
				</mr:ActionBinding>
