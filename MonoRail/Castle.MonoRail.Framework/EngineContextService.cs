...
namespace Castle.MonoRail.Framework
{
	...
	/// </summary>
	public class EngineContextService : AbstractServiceContainer
	{
		private ILogger log = NullLogger.Instance;
		
		private bool initialized;
		
		private EngineContextModule module;
		...
		internal EngineContextService(EngineContextModule module, ILogger log)
		{
			this.log = log;
			
			log.Debug("Created a new EngineContextService");
		}
		
		/// <summary>
		/// Configures the framework and starts the services.
		/// </summary>
		public void Initialize()
		{
			...
			MonoRailConfiguration config = InitConfiguration();
		...
		internal void InitApplicationHooks(HttpApplication context)
		{
		...
		/// </summary>
		private MonoRailConfiguration InitConfiguration()
		{
		...
		private IRailsEngineContext ObtainContextFromApplication(object sender)
		{
			HttpApplication app = (HttpApplication) sender;
			HttpContext context = app.Context;
		...
		private IRailsEngineContext CreateRailsEngineContext(HttpContext context)
		{
			...
			if (mrContext == null)
			{
				...
				context.Items[EngineContextModule.RailsContextKey] = mrContext;
			}
		...
		public IRailsEngineContext ObtainRailsEngineContext(HttpContext context)
		{
			return (IRailsEngineContext) context.Items[EngineContextModule.RailsContextKey];
		}
	}
}
