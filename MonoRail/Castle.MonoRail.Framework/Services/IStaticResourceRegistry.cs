...
namespace Castle.MonoRail.Framework.Services
{
	...
	public interface IStaticResourceRegistry
	{
		...
		void RegisterAssemblyResource(string name, string location, string version,
		                              ...
		                              string resourceEntry, string mimeType);
		...
		/// <param name="mimeType">Mime-type.</param>
		void RegisterCustomResource(string name, string location, string version, Castle.Core.Resource.IResource resource, string mimeType);
		...
		/// <param name="mimeType">Mime-type.</param>
		/// <returns></returns>
		string GetResource(string name, string location, string version, out string mimeType);
	}
}