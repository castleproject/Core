...
#pragma warning restore 219
		...
		public void ProxyForNonPublicClass()
		{
			...
			var type = Type.GetType("NLog.Internal.LoggerConfiguration, NLog");
			var exception = Assert.Throws<GeneratorException>(() => generator.CreateClassProxy(type, new StandardInterceptor()));
			Assert.AreEqual(
				"Can not create proxy for type NLog.Internal.LoggerConfiguration because it is not accessible. Make it public, or internal and mark your assembly with [assembly: InternalsVisibleTo(\"DynamicProxyGenAssembly2, PublicKey=\")] attribute, because assembly NLog is strong-named.",
				exception.Message);
		}
