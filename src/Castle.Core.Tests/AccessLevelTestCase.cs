...
namespace Castle.DynamicProxy.Tests
{
	...
	public class AccessLevelTestCase : BasePEVerifyTestCase
	{
        ...
        [Serializable]
        public class TestConstructorGenerationHook : IProxyGenerationHook, IConstructorGenerationHook
        {
            ...
            public ProxyConstructorImplementation DefaultConstructorImplementation { get; set; }
            public ProxyConstructorImplementation ConstructorImplementation { get; set; }
        ...
        [Test]
        public void PrivateConstructorBypassedUsingConstructorGenerationHook()
        {
            var hook = new TestConstructorGenerationHook()
            {
                ConstructorImplementation = ProxyConstructorImplementation.DoNotCallBase,
                DefaultConstructorImplementation = ProxyConstructorImplementation.SkipConstructor
            };

            var pgo = new ProxyGenerationOptions(hook);
            generator.CreateClassProxy(typeof(UninheritableCtorClass), pgo, new object[] { true },
        ...
        [Test]
        public void AutoGeneratedDefaultCtorWithoutDefaultCtorInBase()
        {
            var hook = new TestConstructorGenerationHook()
            {
                ConstructorImplementation = ProxyConstructorImplementation.DoNotCallBase,
                DefaultConstructorImplementation = ProxyConstructorImplementation.DoNotCallBase
            };

            var pgo = new ProxyGenerationOptions(hook);
            generator.CreateClassProxy(typeof(UninheritableCtorClass), pgo,
                                        new StandardInterceptor());
