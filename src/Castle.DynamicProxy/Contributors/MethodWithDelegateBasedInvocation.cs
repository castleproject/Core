namespace Castle.DynamicProxy.Contributors
{
	...
	public class MethodWithDelegateBasedInvocation : MethodGenerator
	{
		...
		public MethodWithDelegateBasedInvocation(MetaMethod method, Reference interceptors, Type invocation, GetTargetExpressionDelegate getTargetExpression, CreateMethodDelegate createMethod, Type @delegate)
