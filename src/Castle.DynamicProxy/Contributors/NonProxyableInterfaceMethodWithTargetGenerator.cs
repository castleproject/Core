...
namespace Castle.DynamicProxy.Contributors
{
	...
	public class NonProxyableInterfaceMethodWithTargetGenerator : MethodGenerator
	{
		...
		public NonProxyableInterfaceMethodWithTargetGenerator(MethodToGenerate method, CreateMethodDelegate createMethod,GetTargetReferenceDelegate getTargetReference)
		{
			this.method = method;
