...
namespace Castle.Components.DictionaryAdapter.Xml
{
	...
	public class XmlDefaultPropertyAccessor : XmlPropertyAccessor
	{
		private readonly string key;

		public XmlDefaultPropertyAccessor(Type type, string key)
			: base(type)
		{
			this.key = key;
		}
