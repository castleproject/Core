...
namespace Castle.DynamicProxy.Contributors
{
	...
	public class AsyncInterfaceProxyWithoutTargetContributor : CompositeTypeContributor
	{
		private readonly GetTargetExpressionDelegate getTargetExpression;
		protected bool canChangeTarget = false;

		public AsyncInterfaceProxyWithoutTargetContributor(INamingScope namingScope, GetTargetExpressionDelegate getTarget)
			: base(namingScope)
		{
		                                                      ...
		                                                      OverrideMethodDelegate overrideMethod)
		{
			...
			return new AsyncMethodWithInvocationGenerator(method,
		...
		private Type GetInvocationType(MetaMethod method, ClassEmitter emitter, ProxyGenerationOptions options)
		{
			...
			if (canChangeTarget)
			{
				invocationInterfaces = new[] { typeof(IInvocationAsync), typeof(IChangeProxyTarget) };
			}
			else
			{
				invocationInterfaces = new[] { typeof(IInvocationAsync) };
			}
