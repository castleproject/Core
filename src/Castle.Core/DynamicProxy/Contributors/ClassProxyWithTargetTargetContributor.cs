...
namespace Castle.DynamicProxy.Contributors
{
	...
	internal class ClassProxyWithTargetTargetContributor : CompositeTypeContributor
	{
		...
		public ClassProxyWithTargetTargetContributor(ProxyGenerationContext context, INamingScope namingScope,
		                                             Type targetType)
		...
		private Type BuildInvocationType(MetaMethod method, ClassEmitter @class)
		{
			...
			return new CompositionInvocationTypeGenerator(Context,
		                                                        ...
		                                                        bool skipInterceptors = false)
		{
			...
			var invocation = new CompositionInvocationTypeGenerator(Context, targetType, method, null, false, contributor)
