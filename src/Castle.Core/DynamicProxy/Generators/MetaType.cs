...
namespace Castle.DynamicProxy.Generators
{
	...
	{
		private readonly ICollection<MetaEvent> events = new MetaTypeElementCollection<MetaEvent>();
		private readonly ICollection<MetaMethod> methods = new MetaTypeElementCollection<MetaMethod>();
		private readonly Dictionary<MethodInfo, MetaMethod> methodsIndex = new Dictionary<MethodInfo, MetaMethod>();
		private readonly ICollection<MetaProperty> properties = new MetaTypeElementCollection<MetaProperty>();
