...
namespace Castle.DynamicProxy.Generators
{
	...
	public class AsyncInterfaceProxyWithoutTargetGenerator : InterfaceProxyWithTargetGenerator
	{
		public AsyncInterfaceProxyWithoutTargetGenerator(ModuleScope scope, Type @interface) : base(scope, @interface)
		{
		}

		protected override string GeneratorType
		{
			get { return ProxyTypeConstants.AsyncInterfaceWithoutTarget; }
		}
		...
		{
			var contributor = new AsyncInterfaceProxyWithoutTargetContributor(namingScope, (c, m) => NullExpression.Instance)
			{ Logger = Logger };
