...
namespace Castle.DynamicProxy
{
	...
	/// <summary>
	///   Provides functionality for disassembling instances of attributes to CustomAttributeInfo form, during the process of emiting new types by DynamicProxy.
	/// </summary>
	public interface IAttributeDisassembler
	{
		/// <summary>
		///   Disassembles given attribute instance back to corresponding CustomAttributeInfo.
		/// </summary>
		/// <param name = "attribute">An instance of attribute to disassemble</param>
		/// <returns><see cref = "CustomAttributeInfo" /> corresponding 1 to 1 to given attribute instance, or null reference.</returns>
		/// <remarks>
		///   Implementers should return <see cref = "CustomAttributeInfo" /> that corresponds to given attribute instance 1 to 1,
		...
		/// </remarks>
		CustomAttributeInfo Disassemble(Attribute attribute);
	}
}