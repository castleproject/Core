namespace NVelocity.Dvsl
{
	...
	internal class Transformer : TransformTool
	{
		/// <summary>
		...
		internal long Transform(TextReader reader, TextWriter writer)
		{
			/*
	    *  parse the document
	    */
		...
		internal long Transform(XmlDocument dom4jdoc, TextWriter writer)
		{
			/*
	    ...
	    */
		...
		protected internal long Transform(DvslNode root, TextWriter writer)
		{
			/*
