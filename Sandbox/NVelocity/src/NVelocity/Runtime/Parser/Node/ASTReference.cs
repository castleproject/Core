namespace NVelocity.Runtime.Parser.Node
{
	...
	public class ASTReference : SimpleNode
	{
		...
		*/
				...
				int loc1 = t.image.LastIndexOf((Char) '$');
	    ...
	    */
		...
		public override bool render(InternalContextAdapter context, TextWriter writer)
		{
			...
			Object value_ = execute(null, context);
			...
			*/
			...
			if (ec != null)
			{
				value_ = ec.referenceInsert(nullString, value_);
			}
		...
		///
		/// </returns>
		public bool setValue(InternalContextAdapter context, Object value_)
		{
			/*
			...
			*/
			...
			try
			{
				...
				*/
				...
				Object[] params_Renamed = new Object[] {value_};
