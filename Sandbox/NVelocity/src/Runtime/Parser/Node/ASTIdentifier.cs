...
namespace NVelocity.Runtime.Parser.Node {
	 ...
	 */
	protected NVelocity.Util.Introspection.Info uberInfo;
	...
	public override System.Object execute(System.Object o, InternalContextAdapter context) {
	    ...
	    */
		 ...
		 */
		if (ec != null && ite.InnerException is System.Exception) {
		    try {
			return ec.methodException(o.GetType(), vg.MethodName, (System.Exception)ite.InnerException);
		    } catch(System.Exception e) {
