namespace NVelocity.Runtime.Parser.Node
{
	...
	public class ASTDivNode : SimpleNode
	{
		...
		public override Object Value(IInternalContextAdapter context)
		{
			...
			{
				runtimeServices.Error(string.Format("{0} side ({1}) of division operation has null value. Operation not possible. {2} [line {3}, column {4}]", (left == null ? "Left" : "Right"), GetChild((left == null ? 0 : 1)).Literal, context.CurrentTemplateName, Line, Column));
				return null;
			}
