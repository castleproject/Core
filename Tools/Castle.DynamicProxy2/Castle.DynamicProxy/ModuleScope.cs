...
namespace Castle.DynamicProxy
{
	...
	public class ModuleScope
	{
		...
		private readonly ThreadSafeDictionary<CacheKey, Type> typeCache = new ThreadSafeDictionary<CacheKey, Type>();

		// Users of ModuleScope should use this lock when accessing the cache
		private readonly SlimReaderWriterLock readerWriterLock = new SlimReaderWriterLock();
