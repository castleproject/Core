...
dotnet restore ./src/Castle.Core.Tests.NonSigned/Castle.Core.Tests.NonSigned.csproj
...
dotnet build ./src/Castle.Core.Tests.NonSigned/Castle.Core.Tests.NonSigned.csproj /p:Configuration=Release || exit 1
...
./src/Castle.Core.Tests.NonSigned/bin/Release/net461/Castle.Core.Tests.NonSigned.exe --result=DesktopClrNonSignedTestResults.xml;format=nunit3
...
dotnet ./src/Castle.Core.Tests.NonSigned/bin/Release/netcoreapp1.1/Castle.Core.Tests.NonSigned.dll --result=NetCoreClrNonSignedTestResults.xml;format=nunit3
