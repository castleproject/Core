...
{
    /// <summary>
    /// Serves as the base class for for controls that represent a MasterPage in Web application. 
    /// You must inherit from this class when developing a web MasterPage.
