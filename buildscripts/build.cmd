...
%UserProfile%\.nuget\packages\nunit.consolerunner\3.6.1\tools\nunit3-console.exe src/Castle.Core.Tests.NonSigned/bin/%Configuration%/net461/Castle.Core.Tests.NonSigned.exe --result=DesktopClrNonSignedTestResults.xml;format=nunit3 || exit /b 1
...
.\src\Castle.Core.Tests.NonSigned\bin\%Configuration%\netcoreapp1.1\Castle.Core.Tests.NonSigned.exe --result=NetCoreClrNonSignedTestResults.xml;format=nunit3 || exit /b 1
