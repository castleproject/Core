...
{
	/// <summary>
	/// Performs property binding for converting string values into Guids.
	/// </summary>
	public class DictionaryAdapterStringToNullableGuidBinder : DictionaryAdapterPropertyBinder
	{
		/// <summary>
		...
		{
			return value == null ? null : new Guid?(new Guid((string) value));
		}
