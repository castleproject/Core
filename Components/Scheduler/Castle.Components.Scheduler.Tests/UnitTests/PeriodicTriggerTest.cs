...
namespace Castle.Components.Scheduler.Tests.UnitTests
{
    ...
    public class PeriodicTriggerTest : BaseUnitTest
    {
        ...
        [Row(1, 0, 1, 10, TriggerScheduleAction.Skip, TriggerScheduleCondition.Latch, 1, false,
           TriggerScheduleAction.Skip, 2, 10, true, false, Description = "Periodic non-zero execution count latch second time yields skip.")]
        ...
        [Row(1, 0, 1, 10, TriggerScheduleAction.Skip, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.Skip, 3, 10, true, true, Description = "Periodic non-zero execution count misfire skip yields skip.")]
        [Row(1, 0, 1, 10, TriggerScheduleAction.ExecuteJob, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.ExecuteJob, 0, 9, true, true, Description = "Periodic non-zero execution count misfire execute yields execute.")]
        [Row(1, 0, 1, 10, TriggerScheduleAction.DeleteJob, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.DeleteJob, 0, 0, false, true, Description = "Periodic non-zero execution count misfire deletejob yields deletejob.")]
        [Row(1, 0, 1, 10, TriggerScheduleAction.Stop, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.Stop, 0, 0, false, true, Description = "Periodic non-zero execution count misfire stop yields stop.")]
        ...
        [Row(1, 0, 1, 0, TriggerScheduleAction.Skip, TriggerScheduleCondition.Latch, 1, true,
           TriggerScheduleAction.Stop, 0, 0, false, true, Description = "Periodic zero execution count latch first time yields stop.")]
        [Row(1, 0, 1, 0, TriggerScheduleAction.Skip, TriggerScheduleCondition.Latch, 1, false,
           TriggerScheduleAction.Stop, 0, 0, false, false, Description = "Periodic zero execution count latch second time yields stop.")]
        ...
        [Row(1, 0, 1, 0, TriggerScheduleAction.Skip, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.Stop, 0, 0, false, true, Description = "Periodic zero execution count misfire skip yields stop.")]
        [Row(1, 0, 1, 0, TriggerScheduleAction.ExecuteJob, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.Stop, 0, 0, false, true, Description = "Periodic zero execution count misfire execute yields stop.")]
        [Row(1, 0, 1, 0, TriggerScheduleAction.DeleteJob, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.DeleteJob, 0, 0, false, true, Description = "Periodic zero execution count misfire deletejob yields deletejob.")]
        [Row(1, 0, 1, 0, TriggerScheduleAction.Stop, TriggerScheduleCondition.Misfire, 2, true,
           TriggerScheduleAction.Stop, 0, 0, false, true, Description = "Periodic zero execution count misfire stop yields stop.")]
        // Periodic time limited triggers, over time
        [Row(1, 3, 1, -1, TriggerScheduleAction.Skip, TriggerScheduleCondition.Latch, 4, true,
           TriggerScheduleAction.Skip, 1, -1, true, true, Description = "Periodic over-time latch first time yields skip (because we want to detect the misfire).")]
        ...
        [Row(1, 3, 1, -1, TriggerScheduleAction.DeleteJob, TriggerScheduleCondition.Misfire, 4, true,
           TriggerScheduleAction.DeleteJob, 0, 0, false, true, Description = "Periodic over-time misfire deletejob yields deletejob.")]
        ...
        [Row(1, 3, 1, -1, TriggerScheduleAction.Skip, TriggerScheduleCondition.Latch, 3, true,
          TriggerScheduleAction.Skip, 1, -1, true, true, Description = "Periodic at end-time latch first time yields skip (because we want to detect the misfire).")]
        ...
        [Row(1, 3, 1, -1, TriggerScheduleAction.Skip, TriggerScheduleCondition.Fire, 3, true,
           TriggerScheduleAction.ExecuteJob, 0, -1, true, true, Description = "Periodic at end-time fire yields execute (because we're exactly on it).")]
        ...
        [Row(1, 3, 1, -1, TriggerScheduleAction.ExecuteJob, TriggerScheduleCondition.Misfire, 3, true,
           TriggerScheduleAction.ExecuteJob, 0, -1, true, true, Description = "Periodic at end-time misfire execute yields stop.")]
        [Row(1, 3, 1, -1, TriggerScheduleAction.DeleteJob, TriggerScheduleCondition.Misfire, 3, true,
           TriggerScheduleAction.DeleteJob, 0, 0, false, true, Description = "Periodic at end-time misfire deletejob yields deletejob.")]
            ...
            int expectedJobExecutionCountRemaining, bool expectedIsActive, bool expectedIsFirstTime)
        {
            ...
            DateTime? expectedFireTime = expectedFireDay != 0 ? new DateTime(1970, 1, expectedFireDay, 0, 0, 0, DateTimeKind.Utc) : (DateTime?) null;
